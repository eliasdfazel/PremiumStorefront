 ...
 * Last modified 12/15/21, 4:59 AM
 *
    ...
    fun startApplicationsSearch(searchQuery: String) {
        ...
        GenericJsonRequest(context, object : JsonRequestResponses {
            ...
            override fun jsonRequestResponseSuccessHandler(rawDataJsonArray: JSONArray) {
                ...
                context.completeSearchLiveData.processApplicationsSearchResults(rawDataJsonArray)
    ...
    fun startGamesSearch(searchQuery: String) {
        ...
        GenericJsonRequest(context, object : JsonRequestResponses {
            ...
            override fun jsonRequestResponseSuccessHandler(rawDataJsonArray: JSONArray) {
                ...
                context.completeSearchLiveData.processGamesSearchResults(rawDataJsonArray)
    ...
    fun startMoviesSearch(searchQuery: String) {
        ...
        GenericJsonRequest(context, object : JsonRequestResponses {
            ...
            override fun jsonRequestResponseSuccessHandler(rawDataJsonArray: JSONArray) {
                ...
                context.completeSearchLiveData.processMoviessSearchResults(rawDataJsonArray)
